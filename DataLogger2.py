...
log_file.write('Timestamp,Voltage1,Voltage2,Current1\n')
...
try:
    while True:
        ...
        if current_time - last_save_time >= LOG_INTERVAL:
            ...
            log_file.write(f"{log_timestamp},{voltage1:.2f},{voltage2:.2f},{current1:.3f}\n")
            log_file.flush()
            print(f"Logged: {log_timestamp}, {voltage1:.2f}, {voltage2:.2f}, {current1:.3f}")
